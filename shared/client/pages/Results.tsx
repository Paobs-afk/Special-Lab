  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 container py-12 md:py-16">
        ...
        {/* New: Document Comparison Component */}
        {analysis.similarities.length > 0 && (
          <DocumentComparison similarities={analysis.similarities} />
        )}

        {/* New: Similarity Graph Component */}
        {analysis.documentCount > 1 && analysis.similarities.length > 0 && (
          <SimilarityGraph 
            documentNames={analysis.matrix.labels}
