...
import { saveAnalysisToHistory } from "@/lib/session-history";
import {
  AlertCircle,
  ArrowLeft,
  Brain,
...
export default function Analyze() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      saveAnalysisToHistory(analysis, documentNames);
              ...
              <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Upload <span className="font-semibold">1 or more documents</span> to compare their similarities, extract key insights, and receive actionable recommendations.
                  </p>
                </div>
                <Link to="/history">
                  <Button variant="outline" size="sm" className="gap-2 flex-shrink-0 w-full sm:w-auto">
